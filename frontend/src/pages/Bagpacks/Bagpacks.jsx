...
const CATEGORIES = [
  { label: 'Laptop Handbags', value: 'Laptop Handbags' },
  { label: 'Laptop Bagpacks', value: 'Laptop Bagpacks' },
  { label: 'Laptop Sleeves', value: 'Laptop Sleeves' },
]
...
const colorCounts = useMemo(() => {
  ...
  APIproducts?.forEach(item => {
    if (item.category === "bagpacks" && Array.isArray(item.colors)) {
  ...
  return counts;
   ...
   const filteredProducts = useMemo(() => {
     let filtered = APIproducts?.filter(p => p.category === "bagpacks") || [];
  ...
  return (
    <div className="p-0">
      ...
      <div className="bg-[#0000001d] border-b flex items-center justify-center px-2 md:px-6 py-6 text-center">
        <h1 className="md:text-2xl text-2xl font-semibold">Laptop Bagpacks</h1>
      </div>
